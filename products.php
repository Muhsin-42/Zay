    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="row">
                <?php
                if ($cat_id == 'All') {
                    $sql = "SELECT * FROM tbl_products ORDER BY date ";
                } else {
                    $sql = "SELECT * FROM tbl_products WHERE cat_id = $cat_id ORDER BY date ";
                }
                $result = mysqli_query($conn, $sql);
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid img-size-this"  src="\mini-project\zay\images\products\<?php echo $row['img1'] ?>">
