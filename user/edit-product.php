<?php include "partials/header.php" ?>
    ...
    if (isset($_SESSION['success'])) {
        ...
        echo '<meta http-equiv="refresh" content="1; url=my-profile&products.php">';



    }
    $sql ="SELECT * FROM tbl_products where p_id='$_GET[pid]'";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" action="" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" value="<?php echo $tbl_product['p_title'] ?>" class="form-control" id="exampleInputName1" placeholder="Title" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputName1">Price</label>
                                                <input type="number" name="price" value="<?php echo $tbl_product['price'] ?>" class="form-control" id="exampleInputName1" placeholder="Price in rupees" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputName1">Brand</label>
                                                <input type="text" name="brand" value="<?php echo $tbl_product['brand'] ?>" class="form-control" id="exampleInputName1" placeholder="Brand" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleTextarea1">Description</label>
                                                <textarea name="desc" class="form-control" id="exampleTextarea1" style="font-size: large;" rows="4" placeholder="Describe your product in detail" required><?php echo $tbl_product['description'] ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleTextarea1">Tags</label>
                                                <textarea name="tags" class="form-control" id="exampleTextarea1" style="font-size: large;" rows="2" placeholder="Add relevant tags to your product" required><?php echo $tbl_product['tags'] ?></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <!-- <textarea name="tags" class="form-control" id="exampleTextarea1" style="font-size: large;" rows="2" placeholder="Add relevant tags to your product" required><?php echo $tbl_product['tags'] ?></textarea> -->
                                                <img class="rounded-circle" src="<?php echo "\mini-project\zay\images\products\\".$tbl_product['img1'] ?>" height="90px" width="90px" alt="">
                                                <label for="exampleTextarea1">Image 2 : </label>
                                                <img class="rounded-circle" src="<?php echo "\mini-project\zay\images\products\\".$tbl_product['img2'] ?>" height="80px" width="80px" alt="">
                                                <label  for="exampleTextarea1">Image 3 : </label>
                                                <img class="rounded-circle" src="<?php echo "\mini-project\zay\images\products\\".$tbl_product['img3'] ?>" height="80px" width="80px" alt="">
                                            </div>
                                            <div class="form-group">
                                                <h4 class="mt-4">New images : </h4>
                                                <label>Image 1</label>
                                            ...
                                            <button name="submit" type="submit" class="btn btn-success mr-2">Update</button>
  ...
  <!-- endinject -->
    ...
    if (isset($_POST['submit'])) 
    {
        ...
        if ($result) {
            $_SESSION['success'] = "Item Updated Sucessfully";
            echo '<meta http-equiv="refresh" content="0; url=edit-product.php">';
        } else
