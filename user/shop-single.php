...
<body>
        ...
        <div class="container pb-5">
            <div class="row">
                ...
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid rounded-lg" src="/mini-project/zay/images/products/<?php echo $tbl_product['img1']; ?>" style="height: 449px; max-height: 449px;" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                ...
                <div class="col-lg-7 mt-5">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <img class="rounded" src="\mini-project\zay\images\profile-pics\<?php echo $tbl_users['profile_pic'] ?>" alt="Profile Pic">
                            <h1 class="h2"><?php echo $tbl_users['full_name'];  ?></h1>

                            <p class="mb-0"><b><i class="fa fa-phone mx-2"></i> </b><?php echo $tbl_users['phno'];  ?></p>
                            <p><b><i class="fas fa-envelope mx-2"></i> </b><?php echo $tbl_users['email'];  ?></p>
                        </div>
                    </div>
                    <!-- Seller Description -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2"><?php echo $tbl_product['p_title'];  ?></h1>
                            <p class="h3 py-2">₹<?php echo $tbl_product['price'];  ?></p>
                            ...
                            <p><?php echo $tbl_product['description'];  ?></p>


                            <h6>Posted on:</h6>
                            <ul class="list-unstyled pb-3">
                                <?php
                                $date = date('j F, Y', strtotime($tbl_product['date']));
                                ?>
                                <li><?php echo $date  ?></li>
                            </ul>
                            ...
                            <form action="" method="post">
                                <div class="row pb-3">
                                    <div class="col d-grid">
                                        <a href="choose-payment.php?pid=<?php echo $tbl_product['p_id'] ?>" class="btn btn-success btn-lg" name="submit">Buy</a>
                                    </div>
                                    <div class="col d-grid">
                                        <button type="submit" class="btn btn-success btn-lg" name="add-wishlist">Add To Wishlist</button>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <section class="py-5">
        <?php 
            $sql = "SELECT * FROM tbl_products WHERE cat_id = '$tbl_product[cat_id]' and p_id != '$tbl_product[p_id]'";
            $result = mysqli_query($conn,$sql);
        ?>
        <div class="container">
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="/mini-project/zay/images/products/<?php echo $tbl_products['img1']; ?>" style="height: 208px; max-height: 208px;">
                        ...
                        <div class="card-body">
                            <a href="shop-single.php" class="h3 text-decoration-none"><?php echo $tbl_products['p_title']; ?></a>
