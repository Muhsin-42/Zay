<?php require "C:\\xampp\htdocs\mini-project\zay\config\constants.php"; ?>
<!DOCTYPE html>
<html lang="en">
...
<ul class="nav d-flex justify-content-arround mx-lg-auto" id="navigation">
    ...
    <li class="nav-item mx-2">
        <div class="navbar">
            <form class="form-inline">
                <input class="form-control" style="display: inline; width: 120px; height: 38px" type="search" placeholder="Search" aria-label="Search">
    ...
    <!-- Start Map -->
    <div id="mapid" style="width: 80%; margin:auto; height: 300px;"></div>
            ...
            <form class="col-md-9 m-auto" method="post" role="form">
                ...
                <div class="row">
                    <div class="col text-end mt-2">
                        <button type="submit" class="btn btn-success btn-lg px-3" name="send">SEND MESSAGE</button>
                    </div>
                </div>
            </form>
        </div>
