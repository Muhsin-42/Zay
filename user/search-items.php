    ...
    <!-- <img src="\mini-project\zay\images\search-banner.png" alt="sdf"> -->
        <div class="container" >
            <form action="" method="get">
                <input type="search" name="keyword" placeholder="Search for Food.." required>
                <input type="submit" name="" value="Search" class="btn btn-success btn-lg" style="height: 50px;">
            </form>
            <h2 class="text-white" style="margin-top: 15px;">Products on Your Search <span  class="h3 text-warning">"<?php echo $search_keyword ?>"</span></h2>
        </div>
    </section>
