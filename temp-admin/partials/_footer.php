<footer class="footer">
  ...
  <script src="\mini-project\zay\admin\vendors/chart.js/Chart.min.js"></script>
  <script src="\mini-project\zay\admin\vendors/datatables.net/jquery.dataTables.js"></script>
  <script src="\mini-project\zay\admin\vendors/datatables.net-bs4/dataTables.bootstrap4.js"></script>
  <script src="\mini-project\zay\admin\js/dataTables.select.min.js"></script>
  <script src="\mini-project\zay\admin\js/dashboard.js"></script>
  <script src="\mini-project\zay\admin\js/Chart.roundedBarCharts.js"></script>
</body>
</html>