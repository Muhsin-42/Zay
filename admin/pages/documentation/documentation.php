                ...
                <div class="row pt-5 mt-5">
                  <div class="col-12 pt-5 text-center">
                    ...
                    <h3 class="text-primary font-weight-light mt-5">
                      ...
                      <a href="http://bootstrapdash.com/demo/skydash/docs/documentation.php" target="_blank" class="text-danger d-block text-truncate">
                        http://bootstrapdash.com/demo/skydash/docs/documentation.php
                      </a>
                    </h3>
