        ...
        <div class="container pb-5">
            <div class="row">
                ...
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="/mini-project/zay/images/products/<?php echo $row['img1']; ?>" style="height: 449px; max-height: 449px;" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" style="height: 108px; max-height: 108px;" src="/mini-project/zay/images/products/<?php echo $row['img1']; ?>" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" style="height: 108px; max-height: 108px;" src="/mini-project/zay/images/products/<?php echo $row['img2']; ?>" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" style="height: 108px; max-height: 108px;" src="/mini-project/zay/images/products/<?php echo $row['img3']; ?>" alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <img src="\mini-project\zay\images\profile-pics\<?php echo $tbl_users['profile_pic'] ?>" alt="profile pic" style="border-radius: 50%; margin-left:30px">
                            <h1 class="h2"><?php echo $tbl_users['full_name'];  ?></h1>

                            <p class="mb-0"><b><i class="fas fa-phone-alt"></i> : </b><?php echo $tbl_users['phno'];  ?></p>
                            <p class="mb-0"><b><i class="fas fa-envelope"></i> : </b><?php echo $tbl_users['email'];  ?></p>
                            <p class="mb-0"><b><i class="fas fa-map-marker-alt fa-fw"></i>: </b><?php echo $tbl_users['city'].', '.$tbl_users['street'];  ?></p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p style="margin-left: 10%"><?php echo $row['description'];  ?></p>
                            ...
                            <form action="" method="post">
                                <div class="row pb-3">
                                    <div class="col d-grid">
                                        <a href="login.php" class="btn btn-success btn-lg" name="submit">Buy</a>
                                    </div>
                                    <div class="col d-grid">
                                        <button type="submit" class="btn btn-success btn-lg" name="submit">Add To Wishlist</button>
                                    </div>
                                </div>
                            </form>
